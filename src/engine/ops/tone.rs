...
mod tests {
    ...
    fn range_delta_targets_correct_zones() {
        ...
        assert!(
            range_delta(0.8, 1.0, 0.0, 0.0, 0.0, 0.3) > range_delta(0.2, 1.0, 0.0, 0.0, 0.0, 0.3)
        );
        // Positive shadows slider lifts dark tones more than bright ones.
        assert!(
            range_delta(0.2, 0.0, 1.0, 0.0, 0.0, 0.3) > range_delta(0.8, 0.0, 1.0, 0.0, 0.0, 0.3)
        );
        // Strength scales the effect.
        assert!(
            range_delta(0.8, 1.0, 0.0, 0.0, 0.0, 0.6) > range_delta(0.8, 1.0, 0.0, 0.0, 0.0, 0.3)
        );
    }
